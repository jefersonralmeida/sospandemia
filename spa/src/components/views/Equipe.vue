<template>
  <div class="equipe">
    ...
    <main role="main">
      ...
      <h1 class="jumbotron-heading text-center">Aqui somos SOS Pandemia!</h1>
      ...
      <p class="lead text-muted">O sistema desenvolvido e denotado por SOS Pandemia é caracterizado por uma plataforma de infraestrutura web responsiva para dispositivos móveis, possibilita aos usuários uma interface simples e fácil de operação com garantia de ações rápidas.  Os recursos e demandas são possíveis de serem rastreados, controlados e gerenciados em tempo real com informações de status e uma integração sistemas de almoxarifado, manutenção e compras. Consequentemente, o controle de fluxo de equipamentos e componentes pode ser melhor utilizado.</p>
